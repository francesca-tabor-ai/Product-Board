...
import { generateCustomerSegments } from '../services/geminiService';
      ...
      <header className="px-10 py-10 border-b border-gray-50 bg-white flex items-end justify-between shrink-0">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold shadow-sm hover:bg-indigo-100 transition-all border border-indigo-100 flex items-center space-x-2"
          >
          ...
          {viewMode === 'board' ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div 
                ...
                className={`bg-indigo-50/50 border-2 border-dashed border-indigo-200 rounded-[40px] p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-indigo-50 transition-all ${isGenerating ? 'animate-pulse' : ''}`}
              >
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white w-full max-w-xl rounded-[40px] shadow-2xl overflow-hidden animate-slideUp">
             ...
             <div className="p-10 space-y-6">
                ...
                <button 
                  onClick={handleAutoGenerate}
                  className="w-full py-5 bg-indigo-50 text-indigo-600 rounded-2xl font-black text-sm hover:bg-indigo-100 transition-all border border-indigo-100 flex items-center justify-center space-x-3"
                >
